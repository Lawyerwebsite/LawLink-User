...
const TestimonialSlider = () => {
  ...
  useEffect(() => {
    if (sliderRef.current && !keenSliderInstance.current) {
      keenSliderInstance.current = new KeenSlider(sliderRef.current, {
        ...
        created(slider) {
          ...
          document.getElementById("keen-slider-active").textContent =
            slider.track.details.rel + 1;
          document.getElementById("keen-slider-count").textContent =
    ...
    return () => {
      if (keenSliderInstance.current) {
        ...
        keenSliderInstance.current = null;
      }
    };
  }, []);
