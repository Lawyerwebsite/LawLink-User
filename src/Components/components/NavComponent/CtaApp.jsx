...
// //         <form
// //           className="bg-white shadow-lg w-[50%] rounded-lg p-10 gap-3 border"
...
//         const options = {
//           key: "rzp_test_AV5koCUvn01wm6",
//           amount: paymentOptions.amount,
//           currency: paymentOptions.currency,
//           name: "Appoitment Booking",
...
//                   appointmentDiscribe: formData.discribe,
//                   lawyerId: lawyerId,
...
//             <button
//               type="submit"
//               className="bg-blue-600 text-white text-lg font-semibold w-full py-3 mt-6 rounded hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300"
//             >
//               Submit
//             </button>
//           </form>
